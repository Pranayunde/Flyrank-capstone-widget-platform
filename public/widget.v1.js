(function () {
  ...
  /*
  |--------------------------------------------------------------------------
  | Find the script that loaded the widget
  |--------------------------------------------------------------------------
  */
  const currentScript =
  ...
  if (!currentScript) {
    console.error(
      "FlyRank Widget: Unable to find script element."
    );
  ...
  */
  function renderWidget(widget) {
    ...
    */
    ...
    honeypot.style.position =
      "absolute";

    honeypot.style.left =
      "-9999px";

    honeypot.style.width =
      "1px";

    honeypot.style.height =
      "1px";

    honeypot.style.opacity =
      "0";

    honeypot.style.pointerEvents =
      "none";
